...
function myFunction() {
    ...
    var us.indexOf(md5(document.getElementById("username").value)) = us.indexOf(md5(document.getElementById("username").value))
    ...
    if (us.indexOf(md5(document.getElementById("username").value)) != '-1', sp == md5(document.getElementById("password").value)) {
